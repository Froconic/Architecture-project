...
var main = (function ($) {
  var _ = {
    ...
    initEvents: function () {
      ...
      _.$viewer
        ...
        .on('touchmove', function (event) {
          ...
          var diffY = _.$viewer.touchPosY - event.originalEvent.touches[0].pageY
          boundary = 20,
            delta = 50
          ...
          var ts = (_.$viewer.get(0).scrollHeight - _.$viewer.scrollTop())
      ...
      _.$main
        ...
        .on('touchmove', function (event) {
          ...
          var diffY = _.$main.touchPosY - event.originalEvent.touches[0].pageY
          boundary = 20,
            delta = 50,
            result = false
          ...
          var ts = (_.$main.get(0).scrollHeight - _.$main.scrollTop())
    ...
    up: function () {
      ...
      var c = _.current;
      var l = _.slides.length;
      var tpr = _.settings.thumbnailsPerRow
